BAK ORIGINAL/*void cloud_cb_ (const pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr &cloud)
  {
...
void
pcl::RealSenseGrabber::get_ROA_pos (pcl::PointXYZ OriginalCloud, pcl::PointXYZ ROA_Cloud){

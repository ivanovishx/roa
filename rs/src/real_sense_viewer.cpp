...
//Testing  https://github.com/Blitzman/object-recognition/blob/master/Grabber.h
...
printHelp (int, char **argv)
{
  ...
  std::cout << "****************************************************************************" << std::endl;
  std::cout << "*                                                                          *" << std::endl;
  std::cout << "*                      IVAN -  REAL SENSE VIEWER - Usage Guide                   *" << std::endl;
  std::cout << "*                                                                          *" << std::endl;
  std::cout << "****************************************************************************" << std::endl;
  std::cout << std::endl;
...
{
  print_info ("Tesis for Ivan Lozano Viewer for RealSense devices (run with --help for more information)\n", argv[0]);
///////////////////////////////////////////////START PARAMS
